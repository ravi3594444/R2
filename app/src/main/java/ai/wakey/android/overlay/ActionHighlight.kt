...
internal fun ActionHighlight(flash: HighlightFlash?, origin: () -> IntOffset) {
    ...
    Canvas(Modifier.fillMaxSize()) {
        ...
        drawRoundRect(WakeyColors.Amber.copy(alpha = 0.16f * alpha), topLeft, Size(width, height), corner)
        drawRoundRect(WakeyColors.Amber.copy(alpha = 0.9f * alpha), topLeft, Size(width, height), corner, style = Stroke(2.5.dp.toPx()))
    }
}
